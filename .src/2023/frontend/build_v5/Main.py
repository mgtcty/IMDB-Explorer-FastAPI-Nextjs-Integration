...
from Frames import Frame1, Frame2, Frame3, Frame4, Frame5, Frame6
...
class MainApp: # Class for the App itself
    ...
    def show_frame1(self):
        ...
        self.frame4.entry_1.delete(0, 'end')
        self.frame4.entry_2.delete(0, 'end')
        self.frame4.entry_3.delete(0, 'end')
        self.frame4.entry_4.delete(0, 'end')
        self.frame3.entry_1.delete(0, 'end')
        self.frame3.entry_2.delete(0, 'end')
        self.frame6.entry_1.delete(0, 'end')
    ...
    def show_frame6(self):
        self.hide_current_frame()
        self.frame6.frame.pack()
        self.frame6.reshow_widgets() 
        self.current_frame = self.frame6
