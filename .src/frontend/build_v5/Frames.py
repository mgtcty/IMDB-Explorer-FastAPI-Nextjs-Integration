...
ASSETS_PATH_6 = OUTPUT_PATH / Path(r"assets\frame5")
...
class Frame1:
    def __init__(self, parent, switch_frame):
        ...
        self.button1.place(x=221.0, y=641.0, width=495.0, height=147.0)

        self.button2_image = PhotoImage(file=relative_to_assets_frame1("button_2.png"))
        self.button2 = Button(
            self.frame,
            image=self.button2_image,
            borderwidth=0,
            highlightthickness=0,
            command=self.switch_to_frame6,
            relief="flat"
        )
        self.button2.place(x=748.0, y=641.0, width=495.0, height=147.0)
    ...
    def switch_to_frame6(self):
        self.frame.pack_forget()
        self.switch_frame.show_frame6()
...
class Frame4:
    ...
    def switch_to_frame5(self):
        ...
        if self.movie_name.strip() == '':
            messagebox.showerror("Error","Invalid Input. Please enter a movie title.")
            raise ValueError
...
#Additional frame for the function of deleting data entries
class Frame6:
    def __init__(self, parent, switch_frame):
        # General GUI code
        self.parent = parent
        ...
        self.image_4 = PhotoImage(
            file=relative_to_assets_frame6("image_4.png"))
        self.canvas_image_4 = self.frame.create_image(
            726.0,
            408.0,
            image=self.image_4
        )
        ...
        self.image_5 = PhotoImage(
            file=relative_to_assets_frame6("image_5.png"))
        self.canvas_image_5 = self.frame.create_image(
            275.0,
            527.0,
            image=self.image_5
